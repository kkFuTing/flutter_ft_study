...
//双轮交通工具
 mixin class TwoWheelTransportation {
  String powerUnit() => "两个轮子";
}

//四轮交通工具，一般来说安全性能为中
mixin class FourWheelTransportation {
  String powerUnit() => "四个轮子";
}

//安全指数中等的交通工具儿
mixin class MiddleSafetyIndex {
  String safetyIndex() => "middle";
}

//安全指数低的交通工具儿
mixin class LowSafetyIndex {
  String safetyIndex() => "low";
}
...
//汽油能源交通工具
mixin class GasolineEnergyTransportation {
  String energy() => "汽油";
}
...
class AB extends P with A, B {} //B会覆盖A，输出B

class BA extends P with B, A {} //A会覆盖B，输出A

class C extends P with B, A {//C会覆盖B和A，输出C
  String getMessage() => 'C'; //优先级最高的是在具体类中的方法。
}

class CC extends P with B implements A {//打印B
