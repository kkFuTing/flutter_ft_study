...
const List<EventCategoryDef> kEventCategories = <EventCategoryDef>[
  ...
  EventCategoryDef(key: '通勤/外出', chips: ['通勤', '外出买东西', '买菜']),
  ...
  EventCategoryDef(key: '娱乐', chips: ['刷抖音', '刷小红书', '看视频']),
  EventCategoryDef(key: '家务', chips: ['晾衣服', '备菜', '打扫卫生', '打扫房间', '收拾厨房']),
  EventCategoryDef(
    key: '线上购物',
    chips: ['纯逛', '线上买菜', '买衣服', '买鞋', '买化妆品', '买其他'],
  ),
  EventCategoryDef(key: '杂事', chips: ['拿快递', '取外卖']),
  EventCategoryDef(
    key: '化妆',
    chips: ['日常化妆', '化妆在家练习', '化妆课', '化妆课上练习', '化妆课上模特'],
  ),
