...
const List<EventCategoryDef> kEventCategories = <EventCategoryDef>[
  ...
  EventCategoryDef(key: '饮食', chips: ['吃饭', '热饭', '洗碗', '倒水']),
  ...
  EventCategoryDef(key: '个人成长', chips: ['背单词', '英语学习', '口语表达训练']),
  EventCategoryDef(
    key: '运动',
    chips: ['爵士舞', '散步', '跑步', '跳绳', '羽毛球', '乒乓球', '篮球', '爬山'],
  ),
  EventCategoryDef(key: '娱乐', chips: ['刷抖音', '刷小红书', '看视频','听音乐']),
  EventCategoryDef(key: '家务', chips: ['晾衣服', '备菜', '打扫卫生', '打扫房间', '收拾厨房']),
  EventCategoryDef(
    key: '线上购物',
    chips: ['线上纯逛', '线上买菜', '线上买衣服', '线上买鞋', '线上买化妆品', '线上买其他'],
  ),
  EventCategoryDef(key: '线下购物', chips: ['线下买菜', '线下买衣服', '线下买鞋', '线下买化妆品', '线下买其他']),
  ...
  EventCategoryDef(key: '社交', chips: ['社交','聊天','社交软件聊天','电话']),
  EventCategoryDef(key: '其他', chips: ['其他']),
];
