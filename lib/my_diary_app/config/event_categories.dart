...
const List<EventCategoryDef> kEventCategories = <EventCategoryDef>[
  ...
  EventCategoryDef(key: '饮食', chips: ['早餐', '吃饭', '热饭', '洗碗', '倒水', '点外卖']),
  ...
  EventCategoryDef(
    key: '线下购物',
    chips: ['线下买菜', '线下买水果', '线下买零食', '线下买衣服', '线下买鞋', '线下买化妆品', '线下买其他'],
  ),
  EventCategoryDef(
    key: '外出放松',
    chips: ['纯逛', '逛街', '逛公园', '逛商场', '逛超市', '逛菜市场', '逛夜市', '逛其他'],
  ),

  EventCategoryDef(key: '杂事', chips: ['拿快递', '取外卖']),
  EventCategoryDef(
    key: '化妆',
    chips: ['日常化妆', '化妆在家练习', '化妆课', '化妆课上练习', '化妆课上模特', '卸妆洗脸','清理化妆工具'],
  ),
